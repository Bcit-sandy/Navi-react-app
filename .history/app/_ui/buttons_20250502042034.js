...
// Ellipse button with text - Sandy
export function EllipseButton({ onClick, title, subtitle, imageSrc }) {
    return (
        <button className="ellipse-button" onClick={onClick}>
            <div className="ellipse-image-container">
                <Image 
                    src={imageSrc}
                    alt="ellipse image"
                    width={48}
            ...
            <div className="ellipse-button-content">
                <p className="ellipse-button-title">{title}</p>
                <p className="ellipse-button-subtitle">{subtitle}</p>
            </div>
        </button>
    );
}
