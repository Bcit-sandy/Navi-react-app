...
export function StudentCategory({ onSelect }) {
    return (
        <div className='student-categories'>
            <button
                className='category-btn'
                onClick={() => onSelect("highschool")}
            >
                <div className='category-img highschool-img'></div>
                <span>High School Student</span>
            </button>

            <button
                className='category-btn'
                onClick={() => onSelect("postgrad")}
            >
                <div className='category-img postgrad-img'></div>
                <span>Post-Grad Student</span>
            </button>
            ...
            >
                <div className='category-img break-img'></div>
                <span>Student taking a break</span>
            </button>
            ...
            >
                <div className='category-img other-img'></div>
                <span>Other</span>
            </button>
        </div>
    );
